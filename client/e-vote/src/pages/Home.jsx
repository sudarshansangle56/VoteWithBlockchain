  ...
  const features = [
    {
      ...
      description:
        "Immutable voting records secured by distributed ledger technology",
    ...
    },
    {
      ...
      description:
        "Multi-factor verification using facial recognition and fingerprints",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Experience the future of voting with blockchain-secured,
              biometrically-authenticated elections powered by fog computing for
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
            {stats.map((stat, idx) => (
              <div
                key={idx}
                className="text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 hover:bg-white/80 hover:shadow-lg transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Built on the most advanced security infrastructure
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, idx) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.color} p-3 mb-6 group-hover:scale-110 transition-transform shadow-lg`}
                >
      ...
      <div id="how-it-works" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Four simple steps to secure voting
            </p>
          </div>
          ...
          <div className="relative overflow-hidden p-12 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl shadow-2xl">
            <div className="relative z-10 text-center">
              ...
              <p className="text-xl text-white/90 mb-8">
                Join thousands of voters who trust our blockchain-powered
                platform
              </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-4">
                Revolutionizing democracy with blockchain technology, fog
                computing, and biometric authentication.
              </p>
