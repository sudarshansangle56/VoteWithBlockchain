...
import { 
  User, Lock, Eye, EyeOff, Shield, Fingerprint, Camera, 
  LogIn, CheckCircle, ArrowRight, AlertCircle 
} from 'lucide-react';
...
const LoginPage = () => {
  ...
  // 🔹 Biometric simulation logic (unchanged)
  ...
  // 🔹 Actual login function connected to backend
  const handleLogin = async () => {
    try {
      ...
      // 🔸 API call to backend
      const response = await axios.post("http://localhost:5000/api/voters/login", {
      ...
      if (response.data.success) {
        ...
        setTimeout(() => {
          alert(`Welcome ${response.data.voter.name}! Redirecting to dashboard...`);
      ...
      <div className="max-w-md mx-auto relative">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100 p-8">
          {loginMethod === 'password' ? (
            ...
            /* Biometric Login UI (same as before) */
            <div className="space-y-6">
